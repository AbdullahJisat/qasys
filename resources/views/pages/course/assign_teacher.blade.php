...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <a type="button" href="{{route('course.assign-teacher')}}" class="btn btn-success">Add Course</a>
            @endif
                ...
                <tbody>
                    @forelse ($assign_teacher as $teacher)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('course.assign.edit',$teacher->id)}}" class="btn btn-sm btn-primary">Edit</a>
                                <a href="{{route('course.assign.delete',$teacher->id)}}" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
