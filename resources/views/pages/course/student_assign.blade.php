        ...
        <div class="card">
            <div class="card-body">
                ...
                {{-- <form id="demo-form" data-parsley-validate="" enctype="multipart/form-data" action="{{route('course.store')}}" method="post"> --}}
                    <form action="{{route('course.assign-student.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="course_id[]" multiple id="" class="form-control">
