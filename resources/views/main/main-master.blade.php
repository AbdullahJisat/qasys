        ...
        <!-- Sidebar/menu -->
            ...
            <div class="w3-main" style="margin-left:250px">
              ...
              <div class="w3-display-container w3-container">
                <marquee width="100%" direction="left" height="50px" style="border: 1px solid;padding: 10px 0px 10px 0px;font-size: larger;">
                    NOTICE: 21st Nov 2021 Final Exam will held
                </marquee>
                <img
                  src="{{ asset('l.jpg') }}"
                  alt="Jeans" width="100%" height="300">
              </div>
